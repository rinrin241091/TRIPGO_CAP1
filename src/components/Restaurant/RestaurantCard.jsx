...
const RestaurantCard = ({ restaurant }) => {
  return (
    <div className="w-[260px] mt-4  h-auto rounded-xl overflow-hidden shadow-lg bg-white  ">
      {/* Hình ảnh nhà hàng */}
      ...
      <div className="p-6 ">
        ...
        <button className="h-[43px] w-[110px] bg-blue-900 text-white rounded-2xl hover:bg-blue-700 mt-5 ml-[110px]">
          Xem chi tiết
        </button>
      </div>
    </div>
